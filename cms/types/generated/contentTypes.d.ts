...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    regionalAvailability: Schema.Attribute.Component<
      'regional-control.regional-availability',
      true
    >;
...
export interface ApiRegionRegion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    region_code: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    sales_rep: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiSalesRepSalesRep extends Struct.CollectionTypeSchema {
  collectionName: 'sales_reps';
  info: {
    displayName: 'Sales Rep';
    pluralName: 'sales-reps';
