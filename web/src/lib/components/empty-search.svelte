...
<div class="flex flex-col items-center justify-between gap-4">
	...
	<h3 class="text-2xl font-bold">We couldn't find any products matching your search.</h3>
	<ul class="flex flex-col items-center gap-1 text-muted-foreground">
	...
	<Button class="mt-6 cursor-pointer" href="/">Go to homepage</Button>
</div>
