...
<!-- Rating and reviews -->
				...
				<div class="flex flex-col gap-2">
					...
					>
						<button class={buttonQuantityClass} disabled={productQuantity <= 1} onclick={decreaseQuantity}>-</button>
						<span class="w-10">{productQuantity}</span>
						<button class={buttonQuantityClass} disabled={productQuantity >= product.inventory} onclick={increaseQuantity}>+</button>
					</div>
				</div>
