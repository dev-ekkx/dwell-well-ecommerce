...
<!-- Title and Description -->
    <div class="flex flex-col gap-2">
        <span class="font-semibold text-2xl leading-8 lg:text-3xl lg:leading-10">{title}</span>
...
<!-- View all button -->
    ...
    <div bind:this={trackEl} class="flex items-center gap-4 lg:gap-6 transition-transform duration-300">
